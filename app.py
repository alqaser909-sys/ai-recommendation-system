...
ratings = pd.read_excel(RATINGS_FILE, engine="openpyxl")
behavior = pd.read_excel(BEHAVIOR_FILE, engine="openpyxl")
...
<body>
    <div class="box">
        ...
        <form method="post">
            ...
            <button onclick="this.disabled=true;" type="submit">Login</button>
        </form>
    </div>
</body>
</html>
...
def home():
    ...
    recommended_products = cached_recommend(user_id)
